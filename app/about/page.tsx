...
export const metadata = {
  title: "About",
  description:
    "About PharaLex — a community-built Egyptian hieroglyph dictionary. Data sources, acknowledgments, and how to report issues.",
  alternates: { canonical: "/about" },
  openGraph: {
    title: "About PharaLex",
    description:
      "About PharaLex — a community-built Egyptian hieroglyph dictionary. Data sources, acknowledgments, and how to report issues.",
    url: "/about",
  },
    ...
    <div className="min-h-screen">
      ...
      <main className="py-8 sm:py-12">
        <Container size="lg">
          ...
          {/* Disclaimer */}
          <div className="mb-12 p-5 sm:p-6 rounded-xl bg-gold/8 border border-gold/25">
            <h2 className="font-display text-lg font-semibold text-brown mb-2">
              Data accuracy
            </h2>
            <p className="text-sm text-brown-light leading-relaxed mb-3">
              The dictionary data, hieroglyphic spellings, and sign groupings are
              assembled from multiple open sources (listed below) through automated
              pipelines. While we do our best to ensure accuracy, errors and
              inaccuracies are inevitable. Quadrat layouts are reconstructed
              algorithmically and may not match every scholarly convention.
              Translations are primarily sourced from the Vygus dictionary (2018)
              and Wiktionary, which may be outdated or incomplete.
            </p>
            <p className="text-sm text-brown-light leading-relaxed mb-3">
              This resource should not be used as a sole reference for academic
              work. Always cross-check with established dictionaries such as
              Erman &amp; Grapow, Faulkner, or Hannig.
            </p>
          ...
          <div className="mb-10">
            ...
            <p className="text-brown-light max-w-2xl leading-relaxed">
              ...
              open-data contributors listed here.
            </p>
          </div>
